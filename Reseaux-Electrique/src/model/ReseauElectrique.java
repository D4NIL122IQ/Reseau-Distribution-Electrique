...
public class ReseauElectrique {
	...
	// Ajout d'une Méthode utilitaire : retourne la connexion associée à une maison
	// (ou null si aucune)
	...
	/**
	 * VOTRE VERSION (CORRIGÉE) DE ajoutMaison C'est la bonne logique.
	 */
	...
	/**
	 * Ajoute un générateur au réseau. Si un générateur avec le même nom existe
	 * déjà, met à jour sa capacité maximale.
	 *
	...
	/**
	 * Ajoute une connexion entre une maison et un générateur. Vérifie si les objets
	 * maison et générateur existent (non null) et si la connexion exacte n'existe
	 * pas déjà. Met à jour la charge actuelle du générateur en lui ajoutant la
	 * consommation de la maison. Note : Cette méthode peut créer des connexions
	 * multiples pour une même maison (vers différents générateurs), qui seront
	 * détectées comme des erreurs par la suite.
	 *
	...
	/**
	 * Supprime une connexion spécifique entre une maison et un générateur. Si la
	 * connexion est trouvée, elle est retirée de la liste et la charge du
	 * générateur est mise à jour.
	 *
	...
	/**
	 * Valide la conformité du réseau. Un réseau est considéré comme conforme si
	 * chaque maison enregistrée possède exactement une connexion. Les maisons sans
	...
	public String afficherConnexion() {
		...
		for (Maison m : maisons) {
			...
			// Vérifie si la maison est connectée en utilisant la méthode utilitaire
			// findConnexion()
